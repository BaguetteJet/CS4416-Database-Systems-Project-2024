...
GROUP BY a.artist_id, a.artist_name -- Seperates the values by ther artist
HAVING total_time_played_for > 7; -- Only includes artists that have significant play time
